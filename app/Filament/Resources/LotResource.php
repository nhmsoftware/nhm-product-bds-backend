...
class LotResource extends Resource
{
    ...
    public static function form(Form $form): Form { return $form->schema([
        ...
        Forms\Components\TextInput::make('price')->label('Giá')->mask('999,999,999,999,999')->stripCharacters(',')->dehydrateStateUsing(fn (mixed $state) => AdminOptions::normalizeMoney($state)),
        Forms\Components\TextInput::make('unit_price')->label('Đơn giá/m²')->mask('999,999,999,999,999')->stripCharacters(',')->dehydrateStateUsing(fn (mixed $state) => AdminOptions::normalizeMoney($state)),
